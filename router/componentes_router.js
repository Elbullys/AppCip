...
/*router.post('/Mostrar_Info_Componente', (req, res) => {
    const databusqueda = req.body.databusqueda; // Obtener el dato enviado
    console.log("Datos recibidos en el servidor:", databusqueda); // Imprimir en consola
    // Aquí puedes hacer lo que necesites con databusqueda, como guardarlo en la sesión o procesarlo
    // Redirigir a la vista
    res.render("Mostrar_Info_Componente", { results: databusqueda }); // Asegúrate de que results sea el formato correcto para tu vista
});*/
